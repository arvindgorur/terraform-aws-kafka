...
# variable "role_arn" {
#   description = "ARN of the role to be used by the notebook instance"
#   type        = string
# }
...
#   description = "Lifecycle configuration name to be attached to the notebook instance"
#   type        = string
# }
...
#     error_message = "root_access value should be either 'Enabled' or 'Disabled'"
#   }
# }
...
#       "Disabled"
#     ], var.direct_internet_access)
#     error_message = "direct_internet_access value should be either 'Enabled' or 'Disabled'"
#   }
# }
